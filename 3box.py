...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              BLACK CAT. ^_^")
    runntxt(WW+"   ..................  IS HERE ")
    runntxt(WW+"     ....       MR SHAHID ")
    runntxt(GL+"                   LOVE IS NAME ")
    runntxt(GG+"     ..........     SEX IS GAME ")
    runntxt(Y+"    ............      SO FUCK THE NAME ")
    runntxt(GG+"           PLAY THE GAME ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK FORM BLACK CAT.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            WRITTEN BY: MR. SHAHID          |"
    print GL+"  |           I M HERE TO MAKE HISTORY  |"
    print WW+"  |        TEAM : PAKISTAN            |"
    print Y+"  |             FACEBOOK : 03081008587SAHIL              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   BLACK CAT ^_^   •••••••••|"
    print GG+"  √=============================================√"
